<template>
    <div>
        ...
        <PaatSearchPage
            ...
            @getParams="getParams">
            <el-button slot="left" type="primary">新增</el-button>
            <el-button slot="right" type="primary">编辑</el-button>
            <el-button slot="left" type="danger">删除</el-button>
            <el-alert slot="alert" title="自定义 close-text" type="info" close-text="知道了"></el-alert>
        </PaatSearchPage>
